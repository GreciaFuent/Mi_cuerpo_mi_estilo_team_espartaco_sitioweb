...
function Quienes_somos() {
    return(
        <div className="principal_quines_somos">
            ...
            <div className="div_explicacion">
                ...
                <div className="parte3">
                    <p>Nos hemos comprometido a dar un espacio a las marcas que comparten nuestra visión de una moda verdaderamente inclusiva. Trabajamos incansablemente para que todos nuestros productos sean de la más alta calidad y asequibles para todas las personas, sin importar su talla o su capacidad.</p>
                    <img src="https://elcomercio.pe/resizer/2OE-u3m5HNkwcGMYlMnatxuak4g=/580x330/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/42MPL6LJZZE4LGKQC4WMXOOXGQ.jpg"></img>
                </div>
                <p className="p3">Bienvenidos a 'Mi Cuerpo, Mi Estilo', donde la moda y la inclusión se entrelazan en un abrazo apasionado. Únete a nosotros en este viaje hacia un mundo de posibilidades, donde tu cuerpo y tu estilo se fusionan en una celebración de la diversidad y la autenticidad.</p>
            </div>
            </div>
    )
}
