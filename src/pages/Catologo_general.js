...
function Catologo_general() {
    ...
    return(
        <div className="principal_catalogo">
            ...
            <h1 className="h1_catalogo">Catálogo de productos</h1>
            <Opciones/>
            <p className="explicacion_catalogo"></p>

            <div className="div_general">
                <h2 className="h2">Tallas Grandes</h2>
                <div className="div_tallas_grandes">
                    {components_secciones_img()}
                </div>

                <h2 className="h2">Tallas Pequeñas</h2>
                <div className="div_tallas_peque">
                    {components_secciones_img()}
                </div>


                <h2 className="h2">Ropa Adaptada</h2>
                <div className="div_especiales">
                    {components_secciones_img()}
                </div>


                <h2 className="h2">Mujeres</h2>
                <div className="div_mujeres">
                    {components_secciones_img()}
                </div>

                <h2 className="h2">Hombres</h2>
                <div className="div_hombre">
                    {components_secciones_img()}
                </div>
            </div>
        </div>
...
export default Catologo_general